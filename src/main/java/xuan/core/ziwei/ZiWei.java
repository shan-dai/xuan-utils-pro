...
//*******************************************************************************************************************************
    ...
    public ZiWei(ZiWeiJiChuSetting ziWeiJiChuSetting) {
        ...
        // 1、获取日期
        Map<String, Object> date = ZiWeiJiChuUtil.getDate(ziWeiJiChuSetting);
        this.solar = (Solar) date.get("solar"); // 公历日期
        this.lunar = (Lunar) date.get("lunar"); // 农历日期

        // 2、获取干支
        Map<String, List<String>> ganZhi = ZiWeiJiChuUtil.getGanZhi(ziWeiJiChuSetting, this.lunar);
...
//===============================================================================================================================
    ...
    public String getTaiSuiType() {
        ...
        if (this.ziWeiJiChuSetting.getYearGanZhiType() == 0) {
            return ZiWeiJiChuMap.TAI_SUI_TYPE.get(new Lunar().getYearZhi() + this.yearZhi); // 以正月初一起算
        } else if (this.ziWeiJiChuSetting.getYearGanZhiType() == 1) {
            ZiWeiJiChuMap.TAI_SUI_TYPE.get(new Lunar().getYearZhiByLiChun() + this.yearZhi); // 以立春当天起算
        } else if (this.ziWeiJiChuSetting.getYearGanZhiType() == 2) {
            ZiWeiJiChuMap.TAI_SUI_TYPE.get(new Lunar().getYearZhiExact() + this.yearZhi); // 以立春交接时刻起算
        }

        return ZiWeiJiChuMap.TAI_SUI_TYPE.get(new Lunar().getYearZhi() + this.yearZhi);
    ...
    public List<String> getLiuNianSuiQianZhuXing() {
        // 1、若流年支为空则默认使用出生年年支
        String liuNianZhi = "".equals(this.ziWeiJiChuSetting.getLiuNianZhi()) ? this.yearZhi : this.ziWeiJiChuSetting.getLiuNianZhi();
        return ZiWeiJiChuMap.LIU_NIAN_SUI_QIAN_ZHU_XING.get(liuNianZhi);
    ...
    public List<String> getLiuNianJiangQianZhuXing() {
        // 1、若流年支为空则默认使用出生年年支
        String liuNianZhi = "".equals(this.ziWeiJiChuSetting.getLiuNianZhi()) ? getYearZhi() : this.ziWeiJiChuSetting.getLiuNianZhi();
        return ZiWeiJiChuMap.LIU_NIAN_JIANG_QIAN_ZHU_XING.get(liuNianZhi);
    }
     ...
     * @return 化禄星宫位略解
     */
    public String getHuaLuXingGongWeiLueJie() {
     ...
     * @return 化权星宫位略解
     */
    public String getHuaQuanXingGongWeiLueJie() {
     ...
     * @return 化科星宫位略解
     */
    public String getHuaKeXingGongWeiLueJie() {
     ...
     * @return 化忌星宫位略解
     */
    public String getHuaJiXingGongWeiLueJie() {
    ...
    public String getLiuDou() {
        ...
        // 从子斗宫位起子，顺数至流年支
        for (int i = 0; i < 12; i++) {
            if (!ZiWeiJiChuMap.DI_ZHI[i].equals(liuNianZhi)) {
                ziDouGongWei++;
...
//-------------------------------------------------------------------------------------------------------------------------------
    ...
    public String toString() {
        ...
        return "公历:" + getSolarStr() + "   " +
                ...
                "五不遇时:" + getWuBuYuShi() + "   " +
                "五行局:" + getWuXingJu() + "   " +
                "化禄星宫位略解:" + getHuaLuXingGongWeiLueJie() + "   " +
                "化权星宫位略解:" + getHuaQuanXingGongWeiLueJie() + "   " +
                "化科星宫位略解:" + getHuaKeXingGongWeiLueJie() + "   " +
                "化忌星宫位略解:" + getHuaJiXingGongWeiLueJie();
