...
import xuan.core.qimen.maps.QiMenZhuanPanJiChuMap;
import xuan.core.qimen.utils.QiMenZhuanPanJiChuUtil;
...
//*******************************************************************************************************************************
    ...
    public QiMenZhuanPan(QiMenZhuanPanJiChuSetting qiMenZhuanPanJiChuSetting) {
        ...
        // 1、获取日期
        Map<String, Object> date = QiMenZhuanPanJiChuUtil.getDate(qiMenZhuanPanJiChuSetting);
        this.solar = (Solar) date.get("solar"); // 公历日期
        this.lunar = (Lunar) date.get("lunar"); // 农历日期

        // 2、获取干支
        Map<String, List<String>> ganZhi = QiMenZhuanPanJiChuUtil.getGanZhi(qiMenZhuanPanJiChuSetting, this.lunar);
...
//===============================================================================================================================
    ...
    public String getTaiSuiType() {
        ...
        if (this.qiMenZhuanPanJiChuSetting.getYearGanZhiType() == 0) {
            return QiMenZhuanPanJiChuMap.TAI_SUI_TYPE.get(new Lunar().getYearZhi() + this.yearZhi); // 以正月初一起算
        } else if (this.qiMenZhuanPanJiChuSetting.getYearGanZhiType() == 1) {
            QiMenZhuanPanJiChuMap.TAI_SUI_TYPE.get(new Lunar().getYearZhiByLiChun() + this.yearZhi); // 以立春当天起算
        } else if (this.qiMenZhuanPanJiChuSetting.getYearGanZhiType() == 2) {
            QiMenZhuanPanJiChuMap.TAI_SUI_TYPE.get(new Lunar().getYearZhiExact() + this.yearZhi); // 以立春交接时刻起算
        }

        return QiMenZhuanPanJiChuMap.TAI_SUI_TYPE.get(new Lunar().getYearZhi() + this.yearZhi);
    ...
    public String getPrevJie() {
        return getLunar().getPrevJie(this.qiMenZhuanPanJiChuSetting.getJieQiType() == 0).toString();
    }
    ...
    public String getPrevJieDateStr() {
        return getLunar().getPrevJie(this.qiMenZhuanPanJiChuSetting.getJieQiType() == 0).getSolar().toYmdHms();
    }
    ...
    public String getNextJie() {
        return getLunar().getNextJie(this.qiMenZhuanPanJiChuSetting.getJieQiType() == 0).toString();
    }
    ...
    public String getNextJieDateStr() {
        return getLunar().getNextJie(this.qiMenZhuanPanJiChuSetting.getJieQiType() == 0).getSolar().toYmdHms();
    }
    ...
    public String getPrevQi() {
        return getLunar().getPrevQi(this.qiMenZhuanPanJiChuSetting.getJieQiType() == 0).toString();
    }
    ...
    public String getPrevQiDateStr() {
        return getLunar().getPrevQi(this.qiMenZhuanPanJiChuSetting.getJieQiType() == 0).getSolar().toYmdHms();
    }
    ...
    public String getNextQi() {
        return getLunar().getNextQi(this.qiMenZhuanPanJiChuSetting.getJieQiType() == 0).toString();
    }
    ...
    public String getNextQiDateStr() {
        return getLunar().getNextQi(this.qiMenZhuanPanJiChuSetting.getJieQiType() == 0).getSolar().toYmdHms();
    }
    ...
    /**
     * 获取六仪击邢状态，不包含[天禽星]携带的奇仪（1~9宫）
     *
     * @return 六仪击邢状态，不包含[天禽星]携带的奇仪（如：[, 击邢, , 入墓, , , , , ]）
     */
    public List<String> getLiuYiJiXingTianQinNoLink() {
        return QiMenZhuanPanJiChuUtil.getJiXingRuMuLink(null, this.tianPanQiYiTianQinNo).get("jiXingRuMuLinkTianPanQiYiTianQinNo");
    }

    /**
     * 获取六仪击邢状态，只包含[天禽星]携带的奇仪（1~9宫）
     *
     * @return 六仪击邢状态，只包含[天禽星]携带的奇仪（如：[, , , , , , , , ]）
     */
    public List<String> getLiuYiJiXingTianQinYesLink() {
        return QiMenZhuanPanJiChuUtil.getJiXingRuMuLink(this.tianPanQiYiTianQinYes, null).get("jiXingRuMuLinkTianPanQiYiTianQinYes");
    }
     ...
     * @return 门迫状态（如：[, , , , , , , , ]）
     */
    public List<String> getMenPoLink() {
        return QiMenZhuanPanJiChuUtil.getMenPoLink(this.renPan);
    }
     ...
     */
    public List<List<String>> getBaShenLuoGongLink() {
     ...
     */
    public List<List<String>> getBaMenLuoGongLink() {
     ...
     */
    public List<List<String>> getJiuXingLuoGongLink() {
     ...
     *
     * @return 天盘奇仪与落宫地支的关系，只包含[天禽星]携带的奇仪（如：）
     */
    public Map<Integer, List<List<String>>> getTianPanQiYiLuoGongTianQinYesLink() {
        return QiMenZhuanPanJiChuUtil.getTianPanQiYiLuoGongLink(this.tianPanQiYiTianQinYes, this.tianPanQiYiTianQinNo).get("tianPanQiYiTianQinYes");
    }

    /**
     * 获取天盘奇仪与落宫地支的关系，不包含[天禽星]携带的奇仪（1~9宫）
     *
     * @return 天盘奇仪与落宫地支的关系，不包含[天禽星]携带的奇仪（如：）
     */
    public Map<Integer, List<List<String>>> getTianPanQiYiLuoGongTianQinNoLink() {
        return QiMenZhuanPanJiChuUtil.getTianPanQiYiLuoGongLink(this.tianPanQiYiTianQinYes, this.tianPanQiYiTianQinNo).get("tianPanQiYiTianQinNo");
    }
...
//-------------------------------------------------------------------------------------------------------------------------------
    ...
    private List<String> computeTianDun() {
        ...
        for (int i = 0; i < 9; i++) {
            String to = getTianPanQiYiTianQinYes().get(i); // 每一宫位中的天盘旋转后九星所携带的奇仪，只包含[天禽星]携带的奇仪（1~9宫）
            String ex = getTianPanQiYiTianQinNo().get(i); // 每一宫位中的天盘旋转后九星所携带的奇仪，不包含[天禽星]携带的奇仪（1~9宫）
    ...
    private List<String> computeFengDun() {
        ...
        String to = getTianPanQiYiTianQinYes().get(gongWei); // 巽四宫天盘旋转后九星所携带的奇仪，只包含[天禽星]携带的奇仪（1~9宫）
        String ex = getTianPanQiYiTianQinNo().get(gongWei); // 巽四宫天盘旋转后九星所携带的奇仪，不包含[天禽星]携带的奇仪（1~9宫）
    ...
    private List<String> computeLongDun() {
        ...
        String to = getTianPanQiYiTianQinYes().get(gongWei); // 每一宫位中的天盘旋转后九星所携带的奇仪，只包含[天禽星]携带的奇仪（1~9宫）
        String ex = getTianPanQiYiTianQinNo().get(gongWei); // 每一宫位中的天盘旋转后九星所携带的奇仪，不包含[天禽星]携带的奇仪（1~9宫）
        ...
        if (("乙".equals(to) || "乙".equals(ex)) && ("开门".equals(renPan) || "休门".equals(renPan) || "生门".equals(renPan))) {
            ...
            // 2.1、判断1~9宫信息
            for (int i = 0; i < 9; i++) {
                String to2 = getTianPanQiYiTianQinYes().get(i); // 每一宫位中的天盘旋转后九星所携带的奇仪，只包含[天禽星]携带的奇仪（1~9宫）
                String ex2 = getTianPanQiYiTianQinNo().get(i); // 每一宫位中的天盘旋转后九星所携带的奇仪，不包含[天禽星]携带的奇仪（1~9宫）
    ...
    private List<String> computeHuDun() {
        ...
        String to2 = getTianPanQiYiTianQinYes().get(gongWei); // 每一宫位中的天盘旋转后九星所携带的奇仪，只包含[天禽星]携带的奇仪（1~9宫）
        String ex2 = getTianPanQiYiTianQinNo().get(gongWei); // 每一宫位中的天盘旋转后九星所携带的奇仪，不包含[天禽星]携带的奇仪（1~9宫）
...
//-------------------------------------------------------------------------------------------------------------------------------
     ...
     * 初始化符头、节气
     */
    protected void initializeFuTouAndJieQi() {

        // 1、年家奇门、月家奇门
        if (this.qiMenZhuanPanJiChuSetting.getPaiPanType() == 0 || this.qiMenZhuanPanJiChuSetting.getPaiPanType() == 1) {
            Map<String, String> riZhuFuTou = QiMenZhuanPanJiChuMap.RI_ZHU_FU_TOU; // 日柱对应的符头
            this.fuTou = riZhuFuTou.get(this.dayGanZhi); // 符头
    ...
    private void initializeSanYuanAndJuShu() {
        ...
        */
        ...
        if (this.qiMenZhuanPanJiChuSetting.getPaiPanType() == 1) {
            ...
            if (this.qiMenZhuanPanJiChuSetting.getYueJiaQiJuType() == 0) {
                ...
                // 使用年干支的符头地支起局
                diZhi = sixJiaZiXunShouAndYiZhangMap.get(this.yearGanZhi).get(0).substring(1, 2); // 年干支的符头地支
            }
        ...
        */
        ...
        if (this.qiMenZhuanPanJiChuSetting.getPaiPanType() == 3) {
            // 4.1、计算三元
            Map<String, String> riZhuFuTouMap = QiMenZhuanPanJiChuMap.RI_ZHU_SAN_YUAN; // 日柱对应的三元
            this.sanYuan = riZhuFuTouMap.get(this.dayGanZhi);
            // 3.2、计算局数
            Map<String, List<Integer>> juShuMap = QiMenZhuanPanJiChuMap.JU_SHU; // 二十四节气对应局数
            List<Integer> juShu = juShuMap.get(this.jieQi); // 根据节气获取[上元、中元、下元]对应的局数
            // 3.3、根据三元判断所用局数
     ...
     * 初始化阴阳遁
     */
    protected void initializeYinYangDun() {
     ...
     * 初始化旬首
     */
    protected void initializeXunShou() {
     ...
     * 初始化地盘奇仪、地盘六甲、值符、值使
     */
    protected void initializeDiQiYiLiuJiaFuShi() {

        // 1.1、阳遁
        if ("阳遁".equals(this.yinYangDun)) {
            this.diQiYi = QiMenZhuanPanJiChuMap.DI_YANG_QI_YI.get(getJuShu()); // 奇仪
            this.diLiuJia = QiMenZhuanPanJiChuMap.DI_YANG_LIU_JIA.get(getJuShu()); // 六甲
        } else {
            // 1.2、阴遁
            this.diQiYi = QiMenZhuanPanJiChuMap.DI_YIN_QI_YI.get(getJuShu()); // 奇仪
            this.diLiuJia = QiMenZhuanPanJiChuMap.DI_YIN_LIU_JIA.get(getJuShu()); // 六甲
        }

        // 2、根据旬首和六甲获取旬首落宫
        for (int i = 0; i < this.diLiuJia.size(); i++) {
            if (this.xunShou.equals(this.diLiuJia.get(i))) {
                this.xunShouGongWei = i + 1; // 旬首落宫（即：值符和值符落宫）
        ...
        if ("天禽".equals(QiMenZhuanPanJiChuMap.JIU_XING_INITIAL[this.xunShouGongWei - 1]) || this.xunShouGongWei == 5) {
            ...
            if (this.qiMenZhuanPanJiChuSetting.getZhiShiType() == 1) {
                zhiShi = QiMenZhuanPanJiChuUtil.getZhiShi2(getYinYangDun()); // 计算并返回值使（天禽星为值符时：根据阴阳遁判断）
            } else if (this.qiMenZhuanPanJiChuSetting.getZhiShiType() == 2) {
                zhiShi = QiMenZhuanPanJiChuUtil.getZhiShi3(getJieQi()); // 计算并返回值使（天禽星为值符时：根据节气判断）
            } else {
                zhiShi = QiMenZhuanPanJiChuUtil.getZhiShi1(); // 计算并返回值使（天禽星为值符时：一律用[死门]为值使）
            }
            this.zhiShi = zhiShi;
        } else {
     ...
     * 初始化人盘
     */
    protected void initializeRenPan() {
        ...
        for (int i = 0; i < baMenShun.size(); i++) {
            ...
            for (int j = 0; j < baMen.size(); j++) {
                if (baMen.get(this.newZhiShiGongWei - 1).equals(getZhiShi())) {
                    list = baMen;
                    break;
                }
            }
