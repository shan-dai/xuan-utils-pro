 ...
 * @blessing ☯福生无量☯
 */
public class QiMenZhuanPanTest {
    ...
    public void zhuanPanQiMenTest() {
        ...
        qiMenZhuanPanJiChuSetting.setDate(new Date(2024 - 1900, 1 - 1, 1, 0, 0, 0)); // 日期
        qiMenZhuanPanJiChuSetting.setDateType(0); // 日期类型（0:公历。1:农历）
        qiMenZhuanPanJiChuSetting.setLeapMonthType(0); // 闰月类型（0:不使用闰月。1:使用闰月）
        ...
        qiMenZhuanPanJiChuSetting.setYueJiaQiJuType(1); // 月家奇门起局类型（0:使用年支起局。1:使用年干支的符头地支起局）
        ...
        qiMenZhuanPanJiChuSetting.setHourGanZhiType(0); // 时干支类型（0:支持早子时和晚子时）
        ...
        System.out.println("太岁类型：" + qiMen.getTaiSuiType());
        ...
        System.out.println();
        System.out.println("六仪击刑、奇仪入墓状态（不包含[天禽星]）：" + qiMen.getLiuYiJiXingTianQinNoLink());
        System.out.println("六仪击刑、奇仪入墓状态（只包含[天禽星]）：" + qiMen.getLiuYiJiXingTianQinYesLink());

        System.out.println("\n--------------------------------------------------------------------------------------------------------------\n");

        System.out.println("门迫状态：" + qiMen.getMenPoLink());
        ...
        System.out.println("八神落宫状态：" + qiMen.getBaShenLuoGongLink());
        System.out.println();
        System.out.println("八门落宫状态：" + qiMen.getBaMenLuoGongLink());
        System.out.println();
        System.out.println("九星落宫状态：" + qiMen.getJiuXingLuoGongLink());
