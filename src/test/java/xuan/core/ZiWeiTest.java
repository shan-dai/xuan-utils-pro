...
public class ZiWeiTest {
    ...
    public void ziWeiTest() {
        ...
        ziWeiJiChuSetting.setDate(new Date(2024 - 1900, 1 - 1, 1, 0, 0, 0)); // 日期
        ziWeiJiChuSetting.setDateType(0); // 日期类型（0:公历。1:农历）
        ziWeiJiChuSetting.setLeapMonthType(0); // 闰月类型（0:不使用闰月。1:使用闰月）
        ziWeiJiChuSetting.setJieQiType(1); // 节气类型（0:按天计算。1:按分钟计算）
        ziWeiJiChuSetting.setWuXingJuType(0); // 节五行局类型（0:按年干+命宫地支计算。1:按命宫天干+命宫地支计算）
        ziWeiJiChuSetting.setLiuNianZhi(""); // 流年支
        ...
        ziWeiJiChuSetting.setHourGanZhiType(0); // 时干支类型（0:支持早子时和晚子时）
        ...
        System.out.println("太岁类型：" + ziWei.getTaiSuiType());
        ...
        System.out.println("十二命宫：" + ziWei.getShiErMingGong());
        System.out.println("十二身宫：" + ziWei.getShiErShenGong());
        ...
        System.out.println("紫微星系诸星：" + ziWei.getZiWeiXingXiZhuXing());
        System.out.println("天府星系诸星：" + ziWei.getTianFuXingXiZhuXing());

        System.out.println("时支诸星：" + ziWei.getShiZhiZhuXing());

        System.out.println("\n--------------------------------------------------------------------------------------------------------------\n");

        System.out.println("月支诸星：" + ziWei.getYueZhiZhuXing());

        System.out.println("\n--------------------------------------------------------------------------------------------------------------\n");

        System.out.println("年干诸星：" + ziWei.getNianGanZhuXing());

        System.out.println("\n--------------------------------------------------------------------------------------------------------------\n");

        System.out.println("年支诸星：" + ziWei.getNianZhiZhuXing());

        System.out.println("\n--------------------------------------------------------------------------------------------------------------\n");

        System.out.println("日诸星：" + ziWei.getDayZhuXing());

        System.out.println("\n--------------------------------------------------------------------------------------------------------------\n");

        System.out.println("十二长生：" + ziWei.getShiErZhangSheng());

        System.out.println("\n--------------------------------------------------------------------------------------------------------------\n");

        System.out.println("截路空亡：" + ziWei.getJieLuKongWang());

        System.out.println("\n--------------------------------------------------------------------------------------------------------------\n");

        System.out.println("旬中空亡：" + ziWei.getXunZhongKongWang());

        System.out.println("\n--------------------------------------------------------------------------------------------------------------\n");

        System.out.println("天伤星、天使星：" + ziWei.getTianShangTianShiXing());
        ...
        System.out.println("十二宫博士：" + ziWei.getShiErGongBoShi());

        System.out.println("\n--------------------------------------------------------------------------------------------------------------\n");

        System.out.println("流年岁前诸星：" + ziWei.getLiuNianSuiQianZhuXing());

        System.out.println("\n--------------------------------------------------------------------------------------------------------------\n");

        System.out.println("流年将前诸星：" + ziWei.getLiuNianJiangQianZhuXing());

        System.out.println("\n--------------------------------------------------------------------------------------------------------------\n");

        System.out.println("★ 十二个宫位中每个宫位中的诸星：" + ziWei.getShiErGongZhuXing(false));
        System.out.println();
        System.out.println("★ 十二个宫位中每个宫位中的诸星庙旺平陷关系：" + ziWei.getShiErGongZhuXingGuanXi());

        System.out.println("\n--------------------------------------------------------------------------------------------------------------\n");

        System.out.println("十二个宫位中每个宫位中的四化星：" + ziWei.getShiErGongSiHuaXing());
        System.out.println("十二个宫位中每个宫位中的四化星庙旺平陷关系：" + ziWei.getShiErGongSiHuaXingGuanXi());
