...
public class MeiHuaTest {
    ...
    public void meiHuaTest() {
        ...
        meiHuaJiChuSetting.setDate(new Date(2024 - 1900, 1 - 1, 1, 0, 0, 0)); // 日期
        meiHuaJiChuSetting.setDateType(0); // 日期类型（0:公历。1:农历）
        meiHuaJiChuSetting.setLeapMonthType(0); // 闰月类型（0:不使用闰月。1:使用闰月）
        meiHuaJiChuSetting.setJieQiType(1); // 节气类型（0:按天计算。1:按分钟计算）
        meiHuaJiChuSetting.setPaiPanType(0); // 排盘类型（0:日期。1:自动。2:数字。3:单数。4:双数）
        meiHuaJiChuSetting.setPaiPanShu(111); // 排盘数
        meiHuaJiChuSetting.setPaiPanDanShu(111); // 排盘单数
        meiHuaJiChuSetting.setPaiPanShuangShuOne(111); // 排盘双数1
        meiHuaJiChuSetting.setPaiPanShuangShuTwo(111); // 排盘双数2
        meiHuaJiChuSetting.setPaiPanShuangShuShangXiaGuaType(1); // 双数排盘时上下卦类型（0:双数求和计算上下卦。1:双数不求和计算上下卦）
        meiHuaJiChuSetting.setPaiPanShuangShuDongYaoType(0); // 双数排盘时动爻类型（0:双数求和计算动爻。1:双数求和加时辰数计算动爻）
        ...
        meiHuaJiChuSetting.setHourGanZhiType(0); // 时干支类型（0:支持早子时和晚子时）
        ...
        System.out.println("太岁类型：" + meiHua.getTaiSuiType());
